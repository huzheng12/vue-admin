  ...
  <div class="page">
    ...
    <div class="form">
      <el-form
        ...
        :rules="rules"
      >
        <el-form-item label="语种名称" prop="name">
          <el-input v-model="form.languages" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item size="large">
          <el-button @click="submitForm('form')" type="primary" v-if="$filterBtnRoute(1169)">提交</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
