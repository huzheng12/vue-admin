<template>
  <div class="page">
    <!-- 标题 -->
    <div class="title">
      <span class="title-text">添加Banner</span>
      ...
      >
        ...
        <el-form-item label="上传图片">
         <el-upload
            ...
            <img v-if="form.imageUrl" :src="$ALI_OSS_URL + form.imageUrl" class="avatar">
          ...
          <!-- <el-upload
            ...
            ref="upload"
          >
            <el-button size="small" type="primary">上传图片(电脑端尺寸1920px*540px)</el-button> -->
